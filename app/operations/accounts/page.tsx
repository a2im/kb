...
export default async function OperationsAccounServices() {
  ...
  return (
    ...
    <div className="bggradient2 pt-8 mx-auto">
        <title>Account Services - Operations - A2IM Knowledge Base</title>
        <div className="pt-8 mx-auto max-w-4xl">
          <h2 className="text-center">Account Services</h2>
        </div>
