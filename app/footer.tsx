...
export default function Footer() {
  return (
    <footer className="z-0 w-full ">
        ...
        <div className="max-w-3xl mx-auto justify-center items-center flex flex-col md:gap-20 lg:gap-64 md:flex-row py-10 border-2 border-black rounded-lg bg-stone-100 p-10">
