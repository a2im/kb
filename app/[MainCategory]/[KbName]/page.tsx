...
export default async function OperationsDevelopment({params}: { params: { 
  ...
  return (
    ...
    <h2 className="mx-auto max-w-5xl pt-20 pb-10 text-center">{params.KbName}</h2>
        <div className=" grid grid-cols-0 max-w-3xl relative py-5 mx-auto justify-evenly gap-10 ">
